...
template <>
void DefaultCastRegisterer<dynamicgraph::Vector>::trace(const boost::any& object, std::ostream& os) {
...
template <>
void DefaultCastRegisterer<dynamicgraph::Matrix>::trace(const boost::any& object, std::ostream& os) {
